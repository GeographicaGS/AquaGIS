    ...
    _dml_qry = format('
      ...
      INSERT INTO %s
        ...
        VALUES
          ...
          (''aq_cons.sector.consumption'', ''aq_cons.sector'', ''consumption'', ''Consumo'', ''m³'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": true, "widget": "variable", "default": true}'', ''aq_cons_sector_agg_realtime_hour'', ''aggregated'', TRUE, FALSE),
          (''aq_cons.sector.pressure_agg'', ''aq_cons.sector'', ''pressure_agg'', ''Presión'', ''kgf/cm²'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": false, "default": false}'', ''aq_cons_sector_agg_realtime_hour'', ''aggregated'', TRUE, FALSE),
          (''aq_cons.sector.forecast'', ''aq_cons.sector'', ''forecast'', ''Previsión de consumo'', ''m³'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": true, "widget": "variable", "default": true}'', ''aq_cons_sector_agg_forecast_hour'', ''aggregated'', TRUE, FALSE),
          (''aq_cons.sector.pressure_forecast'', ''aq_cons.sector'', ''pressure_forecast'', ''Previsión de presión'', ''kgf/cm²'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": false, "default": false}'', ''aq_cons_sector_agg_forecast_hour'', ''aggregated'', TRUE, FALSE),
          ...
          (''aq_cons.plot.consumption'', ''aq_cons.plot'', ''consumption'', ''Consumo'', ''m³'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": true, "widget": "variable", "default": true}'', ''aq_cons_plot_agg_realtime_hour'', ''aggregated'', TRUE, FALSE),
          (''aq_cons.plot.pressure_agg'', ''aq_cons.plot'', ''pressure_agg'', ''Presión'', ''kgf/cm²'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": false, "default": false}'', ''aq_cons_plot_agg_realtime_hour'', ''aggregated'', TRUE, FALSE),
          (''aq_cons.plot.forecast'', ''aq_cons.plot'', ''forecast'', ''Previsión de consumo'', ''m³'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": true, "widget": "variable", "default": true}'', ''aq_cons_plot_agg_forecast_hour'', ''aggregated'', TRUE, FALSE),
          (''aq_cons.plot.pressure_forecast'', ''aq_cons.plot'', ''pressure_forecast'', ''Previsión de presión'', ''kgf/cm²'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": false, "default": false}'', ''aq_cons_plot_agg_forecast_hour'', ''aggregated'', TRUE, FALSE),
          ...
          (''aq_cons.const.consumption'', ''aq_cons.const'', ''consumption'', ''Consumo'', ''m³'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": true, "widget": "variable", "default": true}'', ''aq_cons_const_agg_realtime_hour'', ''aggregated'', TRUE, FALSE),
          (''aq_cons.const.pressure_agg'', ''aq_cons.const'', ''pressure_agg'', ''Presión'', ''kgf/cm²'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": false, "default": false}'', ''aq_cons_const_agg_realtime_hour'', ''aggregated'', TRUE, FALSE),
          (''aq_cons.const.forecast'', ''aq_cons.const'', ''forecast'', ''Previsión de consumo'', ''m³'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": true, "widget": "variable", "default": true}'', ''aq_cons_const_agg_forecast_hour'', ''aggregated'', TRUE, FALSE),
          (''aq_cons.const.pressure_forecast'', ''aq_cons.const'', ''pressure_forecast'', ''Previsión de presión'', ''kgf/cm²'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": false, "default": false}'', ''aq_cons_const_agg_forecast_hour'', ''aggregated'', TRUE, FALSE);
      ',
