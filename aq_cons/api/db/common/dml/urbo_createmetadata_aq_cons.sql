    ...
    _dml_qry = format('
      ...
      INSERT INTO %s
        ...
        VALUES
          ...
          (''aq_cons.sector.consumption_agg_hour'', ''aq_cons.sector'', ''consumption'', ''Consumo'', ''m³'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": true, "widget": "variable", "default": true}'', ''aq_cons_cons_agg_hour'', ''aggregated'', TRUE, FALSE),
          (''aq_cons.sector.forecast_agg_hour'', ''aq_cons.sector'', ''forecast'', ''Previsión de consumo'', ''m³'', ''{}'', ''{"SUM", "AVG", "MIN", "MAX"}'', FALSE, ''{"active": true, "widget": "variable", "default": true}'', ''aq_cons_cons_agg_hour'', ''aggregated'', TRUE, FALSE);
      ',
