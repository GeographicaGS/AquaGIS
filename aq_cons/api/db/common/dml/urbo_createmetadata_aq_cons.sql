    ...
    _dml_qry = format('
      ...
      INSERT INTO %s
        ...
        VALUES
          ...
          (''aq_cons.plot.area'',                             ''aq_cons.plot'',       ''area'',                               ''Área'', ''m²'',                           NULL,           NULL,              ''{"SUM", "AVG", "MIN", "MAX"}'',       FALSE,           NULL,                                                             NULL,                                   ''catalogue'',      TRUE,         FALSE   ),
          ...
          (''aq_cons.sensor.electric_conductivity'',          ''aq_cons.sensor'',     ''electric_conductivity'',              ''Conductividad eléctrica'',                ''μS/cm'',      ''{}'',            ''{"SUM", "AVG", "MIN", "MAX"}'',       FALSE,           ''{"active": true, "widget": "variable", "default": true}'',      NULL,                                   ''variable'',       TRUE,         FALSE   ),
          (''aq_cons.sensor.dissolved_oxygen'',               ''aq_cons.sensor'',     ''dissolved_oxygen'',                   ''Oxígeno disuelto'',                       ''mg/L'',       ''{}'',            ''{"SUM", "AVG", "MIN", "MAX"}'',       FALSE,           ''{"active": true, "widget": "variable", "default": true}'',      NULL,                                   ''variable'',       TRUE,         FALSE   ),
          (''aq_cons.sensor.name'',                           ''aq_cons.sensor'',     ''name'',                               ''Nombre del sensor'',                      NULL,           NULL,              ''{"NOAGG"}'',                          FALSE,           NULL,                                                             NULL,                                   ''catalogue'',      FALSE,        FALSE   ),
          (''aq_cons.sensor.ph'',                             ''aq_cons.sensor'',     ''ph'',                                 ''PH'',                                     ''pH'',         ''{}'',            ''{"SUM", "AVG", "MIN", "MAX"}'',       FALSE,           NULL,                                                             NULL,                                   ''variable'',       TRUE,         FALSE   ),
          (''aq_cons.sensor.temperature'',                    ''aq_cons.sensor'',     ''temperature'',                        ''Temperatura'',                            ''°C'',         ''{}'',            ''{"SUM", "AVG", "MIN", "MAX"}'',       FALSE,           NULL,                                                             NULL,                                   ''variable'',       TRUE,         FALSE   )
